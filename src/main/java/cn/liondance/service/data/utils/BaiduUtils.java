...
public class BaiduUtils {
  ...
  /**
   * Translate. 参阅文档 https://fanyi-api.baidu.com/doc/21 成功返回如下
   * {"from":"zh","to":"en","trans_result":[{"src":"\u82f9\u679c","dst":"Apple"}]} 失败返回如下
   * {"error_code":"52003","error_msg":"UNAUTHORIZED USER"} 错误码 含义 解决方法 52000 成功 52001 请求超时 重试 52002
   * 系统错误 重试 52003 未授权用户 请检查您的appid是否正确，或者服务是否开通 54000 必填参数为空 请检查是否少传参数 54001 签名错误 请检查您的签名生成方法 54003
   * 访问频率受限 请降低您的调用频率，或进行身份认证后切换为高级版/尊享版 54004 账户余额不足 请前往管理控制台为账户充值 54005 长query请求频繁
   * 请降低长query的发送频率，3s后再试 58000 客户端IP非法 检查个人资料里填写的IP地址是否正确，可前往开发者信息-基本信息修改，可前往开发者信息-基本信息修改 58001
  ...
  public static String translate(
      String q, String from, String to, Integer tts, Integer dict, Integer action)
      throws IOException, InterruptedException {
    int salt = (int) (Math.random() * (90000000 - 10000000) + 10000000);
    StringBuilder stringBuilder =
        new StringBuilder().append(TRANSLATE_APP_ID).append(q).append(salt).append(TRANSLATE_KEY);
