...
public class RestClientConfig {
    ...
    @Bean
    public RestHighLevelClient elasticsearchClient() throws KeyStoreException, NoSuchAlgorithmException, KeyManagementException, URISyntaxException {
        ...
        restClientBuilder.setHttpClientConfigCallback(httpClientBuilder ->
                httpClientBuilder
                         ...
                         * 不做SSL校验
                         */
                        .setSSLHostnameVerifier((x, y) -> true).setSSLContext(sslContext)
        );
